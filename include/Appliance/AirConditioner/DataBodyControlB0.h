 ...
 public:
  ...
  DataBodyControlB0(uint8_t funcLo, uint8_t value, std::vector<uint8_t> values, uint8_t sound, uint8_t funcHi) {
    if (funcLo == 0x63 || funcLo == 0x64) {
      // Control function: 0x0018: FEATURE_SILKY_COOL (NoWindFeel)
      ...
      // Control functions:
      // 0x0009: FEATURE_VWIND, 0x000A: FEATURE_HWIND, 0x0030: FEATURE_ECO_EYE, 0x0032: FEATURE_WIND_ON_ME
      // 0x0033: FEATURE_WIND_OFF_ME, 0x0039: FEATURE_CLEAN, 0x0042: FEATURE_BREEZE_AWAY
      // 0x0043: FEATURE_BREEZELESS, 0x0067: JET_COOL
      // Device: 0xAC, FrameType: 0x02
      ...
      // 0x004B: FRESH_AIR [0x01, 0x03, 0xFF, 0xFF], 0x0043: FEATURE_BREEZELESS [0x04]
      // Device: 0xAC, FrameType: 0x02
      m_data = {0xB0, 0x02, 0x4B, 0x00, 0x04, 0x01, 0x03, 0xFF, 0xFF, 0x43, 0x00, 0x01, 0x04};
    } else if (funcLo == 105) {
      // Control function 105:
      // 0x0043: FEATURE_BREEZELESS [0x04]
      // Device: 0xAC, FrameType: 0x02
